  ...
  return (
    <header className="gaaga-hero min-h-[360px] md:min-h-165 bg-[#18092D7D] relative mb-8 flex items-center justify-center">
      <SlideUp className="z-30 text-center pt-20 md:pt-28 px-4">
        ...
        <p className="text-lg md:text-[28px] font-avenir-light leading-relaxed md:leading-none w-[92%] md:w-[60%] mb-8 md:mb-16 mx-auto text-white">
        ...
        <Link href="/booking" className="uppercase font-milker bg-accent relative py-3 md:py-5 rounded-lg px-5 md:px-7 text-base md:text-lg">Start a brief</Link>
      </SlideUp>
      <Image src={LayerImg} alt="background gradient" width={1000} height={1000} className="absolute inset-0 w-full h-full z-20" />
    </header>
  );
};
