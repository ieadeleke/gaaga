  ...
  return (
    <header className="gaaga-hero min-h-165 bg-[#18092D7D] relative mb-8 flex items-center justify-center">
      <div className="z-30 text-center pt-28">
        <h2 className="text-[50px] leading-none text-accent uppercase w-[50%] mx-auto mb-4">
          Create With the Culture.
        </h2>
        <p className="text-[32px] font-avenir-light leading-loose md:leading-none w-[50%] mb-16 mx-auto text-white">
        ...
        <Link href="" className="uppercase font-milker bg-accent relative py-5 rounded-lg px-7 text-lg">Get Started</Link>
      </div>
      <Image
        src={LayerImg}
